...
INSERT INTO blog_comments (slug, author_name, comment, approved, created_at) VALUES
  ...
  ('how-ats-systems-work-rolebud', 'Jordan Ellis', 'I had no idea ATS systems rejected 75% of applications automatically. This explains so much about my job search.', true, '2026-02-16T11:00:00Z'),
  ('how-ats-systems-work-rolebud', 'Amanda Foster', 'The 3-tier approach is brilliant. Most tools just blast keywords everywhere.', true, '2026-02-17T14:30:00Z'),
  ('how-ats-systems-work-rolebud', 'Ryan Cooper', 'Sent this to three friends who are job hunting right now. Eye-opening.', true, '2026-02-18T09:45:00Z'),
