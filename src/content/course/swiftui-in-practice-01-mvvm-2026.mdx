...
<div class="not-prose my-8 flex flex-col sm:flex-row gap-6 items-start justify-center">
  ...
  <figure class="m-0 flex-shrink-0">
    <video src="/images/courses/swiftui-in-practice/01-mvvm-2026/videos/demo.mov" controls muted playsinline class="block max-w-[260px] rounded-2xl border border-border m-0"></video>
