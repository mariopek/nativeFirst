...
This was [ThinkBud](https://apps.apple.com/rs/app/thinkbud-notes-flashcards/id6759010323)'s breakthrough on the import flow: the success path was easy, the four failure modes were what took a week. Once we had them as explicit enum cases, all four UI states became obvious to design and implement.
