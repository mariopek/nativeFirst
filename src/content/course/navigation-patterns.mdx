...
description: "Master modern SwiftUI navigation — NavigationStack, TabView, sheets, programmatic navigation, and the common bugs AI generates that you need to fix."
...
topics: ["Navigation", "TabView", "NavigationStack", "Deep Linking", "SwiftUI Routing", "Sheets", "Programmatic Navigation", "UI Patterns"]
author: "Mario"
draft: false
pubDate: 2026-02-22
---
