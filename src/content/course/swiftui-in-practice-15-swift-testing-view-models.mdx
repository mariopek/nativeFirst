...
[ThinkBud](https://apps.apple.com/app/thinkbud/id6743296798)'s entire view-state layer is tested this way. ~120 tests, run on every commit, full suite under 4 seconds. The first 30 took an afternoon. After that, writing the test is faster than not writing it — because debugging without tests is the slow path.
