...
[ABNetworking](https://github.com/mariopek/ABNetworking) is the same shape, scaled for production. [ThinkBud](https://apps.apple.com/rs/app/thinkbud-notes-flashcards/id6759010323) is what these patterns look like with two years of iteration on top. The leap from Pulse to ThinkBud is half a year of refinement and a proper team — but the bones are the same.
