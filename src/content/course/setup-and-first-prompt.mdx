---
title: "Setup & Your First Prompt"
description: "Install Claude Code, create your first CLAUDE.md, and generate a complete SwiftUI profile screen using AI — a step-by-step beginner guide."
...
difficulty: "beginner"
topics: ["Claude Code", "Setup", "SwiftUI", "CLAUDE.md", "Getting Started", "Installation", "Tutorial", "First Project"]
author: "Mario"
draft: false
pubDate: 2026-02-22
---
...
![The vibe coding workflow — describe, review, refine, repeat](/images/course/setup-workflow.svg)
