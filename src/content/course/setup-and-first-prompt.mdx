...
description: "Install Claude Code, create your first CLAUDE.md configuration file, and generate a complete SwiftUI profile screen using AI — step by step."
module: 1
moduleTitle: "Introduction to Vibe Coding"
lesson: 3
duration: "20 min read"
difficulty: "beginner"
topics: ["Claude Code", "Setup", "SwiftUI", "CLAUDE.md"]
author: "Mario"
draft: false
pubDate: 2026-02-22
---
