...
description: "How to plan a complete iOS app before writing any code — using AI to brainstorm features, define data models, scope an MVP, and create the CLAUDE.md that guides your entire build."
module: 3
moduleTitle: "Your First App — Todo App with AI"
lesson: 1
duration: "14 min read"
difficulty: "intermediate"
topics: ["Planning", "Architecture", "CLAUDE.md", "Todo App"]
author: "Mario"
draft: false
pubDate: 2026-02-22
---
