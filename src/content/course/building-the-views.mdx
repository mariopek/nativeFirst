...
description: "Build every view in the Todo app using AI — from the main list with sections to the add form and detail editor — using iterative prompting and the refinement ladder."
module: 3
moduleTitle: "Your First App — Todo App with AI"
lesson: 3
duration: "18 min read"
difficulty: "intermediate"
topics: ["SwiftUI", "Views", "Navigation", "Todo App"]
author: "Mario"
draft: false
pubDate: 2026-02-22
---
