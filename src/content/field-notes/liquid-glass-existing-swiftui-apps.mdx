...
[Day 5 covers custom Liquid Glass components](./custom-liquid-glass-components) — when to leave the system defaults and roll your own shape, plus the layering pitfalls that quietly tank scroll performance.
