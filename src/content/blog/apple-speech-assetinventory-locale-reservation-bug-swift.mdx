...
A developer building [Vocapa](https://apps.apple.com/app/id6789586072), a voice-notes app that runs transcription and Foundation Models enrichment entirely on-device — the same category of app as [ThinkBud](/apps/thinkbud), which leans on the same on-device Foundation Models stack for its own bounded tasks — posted a detailed field report to r/swift after shipping. The locale reservation system was the thing that cost them an architecture:
