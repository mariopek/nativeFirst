...
Claude Code boots up, speed-reads your project like it's cramming for an exam, and confirms remote access is live.
...
You're sending text, not streaming 4K. Commands go through fine on mediocre cellular. I've sent commands from the Belgrade metro — if that's not a connectivity stress test, nothing is.
