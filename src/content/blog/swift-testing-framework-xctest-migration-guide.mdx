...
For the [Day 21 TDD post](/blog) tomorrow, we'll use this exact setup — `@Suite`, `#expect`, parametrized assertions — to drive a real feature in BrewLog from zero to working with test-first development. It's a lot more readable than the same loop in XCTest.
