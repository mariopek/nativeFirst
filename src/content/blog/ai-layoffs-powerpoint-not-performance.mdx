...
{/*
  ...
  - Links to /apps/rolebud (job application tool)
...
**If you're job hunting:** The game has changed. ATS systems are more aggressive than ever, and companies are filtering harder. Understanding [how these systems actually work](/blog/how-ats-systems-work-rolebud) and tailoring your applications isn't optional anymore — it's the baseline. Tools like [RoleBud](/apps/rolebud) exist specifically because the application process has become its own adversarial system.
...
- [How ATS Systems Actually Work](/blog/how-ats-systems-work-rolebud)
