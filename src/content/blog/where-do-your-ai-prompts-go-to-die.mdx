...
{/*
  ...
  - Links to /apps/promptkit (product page)
  - Links to /blog/vibe-coding-ios-comprehensive-analysis (for the AI workflow angle)
  - Links to /blog/claude-code-commands-i-actually-use (custom commands = structured prompts)
...
You can set a **default AI per prompt**. My code review prompt always goes to Claude. My marketing copy prompt goes to ChatGPT. My research prompts go to Perplexity. Each prompt knows where it belongs.

There's also a global default in settings. For everything else, your preferred AI is one tap away.

### Workflow Builder

Single prompts are powerful. **Chained prompts are a superpower.**
