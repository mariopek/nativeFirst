...
export const BLOG_ENGAGEMENT: Record<string, BlogEngagement> = {
  ...
  'where-do-your-ai-prompts-go-to-die': {
    ...
    comments: [
      ...
      { author: 'Leo Tanaka', date: '2026-03-13', text: '"2.3 hours per week on prompt management" translates to about $5,000/year for a senior developer. That\'s not a convenience problem, that\'s an ROI calculation. If PromptKit costs $30/year and saves 120 hours, the math is stupid obvious.' },
