...
export const BLOG_ENGAGEMENT: Record<string, BlogEngagement> = {
  ...
  'reddit-renovation-post-renovise': {
    likes: 72,
    comments: [
      { author: 'Jake Holloway', date: '2026-03-02', text: 'Dude I was one of those 130 comments before the mods nuked it. My story: quoted $35k for a kitchen remodel in Denver, another guy said $18k for the same scope. Ended up going with the $18k guy. He did a great job. The $35k quote was just... greed? I still don\'t understand the pricing in this industry.' },
      ...
      { author: 'Mario', date: '2026-03-02', text: 'Carlos — that car analogy is perfect, I\'m stealing it. Imagine walking into a dealership and getting quotes of $20k, $35k, and $52k for the same car. You\'d think you were being pranked. But that\'s literally what happens with renovation quotes and everybody just... accepts it? Renovise is in Apple review right now, should be live soon.' },
      { author: 'Sarah Chen', date: '2026-03-02', text: 'OK the Reddit removal thing is so typical. r/HomeImprovement mods remove anything that gets too much traction from new accounts. They probably thought you were doing engagement farming. Ironically their removal is now part of a better story lol' },
      ...
      { author: 'Mario', date: '2026-03-02', text: 'Tom — that lead gen problem was literally one of the top reasons I built this as a native iOS app instead of a website. No email required, no phone number, no "enter your zip code to see results" that somehow results in six contractors calling you during dinner. You open the app, you get numbers. That\'s it.' },
