...
export const APPS = {
  ...
  thinkbud: {
    ...
    description: 'Import any link, PDF, image, or audio — ThinkBud instantly transforms it into brain maps, summaries, flash cards, quizzes, memory games, and AI podcasts. Daily review with spaced repetition keeps everything locked in. Export stunning PNG mind maps, interactive HTML presentations, or PowerPoint decks.',
    platform: 'iOS' as const,
    status: 'available' as const,
    icon: '/images/apps/thinkbud-icon.png',
    appStoreUrl: 'https://apps.apple.com/app/thinkbud/id6743296798',
    features: [
      { title: 'Import Anything', description: 'Drop a link, PDF, image, or audio file. ThinkBud ingests it and builds learning materials in seconds.', icon: 'import' },
      { title: 'Brain Visual Maps', description: 'Beautiful, interactive mind maps that break any topic into a clear visual structure you can explore and export as PNG.', icon: 'map' },
      { title: 'Smart Flash Cards', description: 'AI-generated flash cards with spaced repetition (SRS). Swipe through and master any subject at your own pace with daily review schedules.', icon: 'layers' },
      { title: 'Quiz & Match Games', description: 'Auto-generated quizzes and memory matching games that make retention feel like play, not work.', icon: 'check-circle' },
      { title: 'AI Summaries', description: 'Key takeaways extracted and organized instantly. Get the gist of any material in seconds, not hours.', icon: 'book' },
      { title: 'AI Podcast', description: 'Turn any content into a podcast-style audio overview. Listen and learn on the go — perfect for commutes and workouts.', icon: 'podcast' },
      { title: 'AI Chat', description: 'Ask questions about your imported content and get instant, context-aware answers. Like having a tutor for every topic.', icon: 'chat' },
