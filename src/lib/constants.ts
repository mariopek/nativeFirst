...
export const APPS = {
  ...
  thinkbud: {
    ...
    features: [
      ...
      { title: 'FSRS-5 Flashcards', description: 'AI-generated flashcards using the FSRS-5 spaced repetition algorithm — the same modern SRS engine that powers serious memorization tools. Daily review keeps everything locked in.', icon: 'layers' },
      { title: 'Quiz, Cloze & Feynman', description: 'Test recall with auto-generated multiple-choice quizzes, fill-in-the-blank cloze exercises, and the Feynman mode — explain a concept back to the AI and get instant feedback.', icon: 'check-circle' },
      { title: 'AI Summaries', description: 'Long-form key takeaways extracted and organized instantly. Get the gist of any article, paper, or recording in seconds, not hours.', icon: 'book' },
      { title: '2-Host AI Podcast', description: 'Turn any content into a 2-host conversational podcast — choose Short, Medium, or Long, and Casual or Academic style. Listen on commutes and workouts.', icon: 'podcast' },
      { title: 'Ask AI About Your Material', description: 'Per-session chat that knows the content you imported. Ask follow-up questions, request examples, and generate new mind maps from the conversation.', icon: 'chat' },
      { title: 'Export & Share Anywhere', description: 'Export brain maps as high-res PNG, complete interactive HTML study files, PowerPoint decks, or share a public link — anyone with the link can view your study materials.', icon: 'export' },
      { title: 'Study Groups & Chat', description: 'Create or join study groups and chat with classmates — text, voice notes, photos, files, location, even disappearing messages. Real-time push, fully native on the Apple stack.', icon: 'chat' },
      { title: 'Weekly League & Streaks', description: 'Five-tier weekly leaderboard (Bronze → Diamond), XP for every review, daily streak tracking, and 16 unlockable achievements. Gamified the right way — quietly motivating, never pushy.', icon: 'check-circle' },
      { title: 'Universal Apple App', description: 'Native on iPhone, iPad, and Mac. iCloud sync via CloudKit keeps everything in lockstep. The Mac app ships with menu bar extra, Command Palette (⌘K), and drag-and-drop import.', icon: 'layers' },
      { title: 'Privacy by Design', description: 'No accounts, no tracking, no ads. Auth via Apple Game Center. Analytics is GDPR-compliant TelemetryDeck — no IDFA, no cross-app tracking, no ATT prompt.', icon: 'book' },
    ],
  },
  rolebud: {
    name: 'RoleBud',
    ...
    features: [
      ...
      { title: 'Interview Coach', description: 'A full interview preparation suite with 35 tailored questions across Overview, Common, STAR, and Technical tabs — each with difficulty ratings and expert tips.', icon: 'bar-chart' },
      ...
      { title: 'Mock Interview', description: '15 timed questions at 2 minutes each. Answer by voice or text and rate yourself after every response to track your confidence.', icon: 'message-circle' },
...
export const BLOG_ENGAGEMENT: Record<string, BlogEngagement> = {
  ...
  'apple-killed-vibe-coding-while-shipping-its-own': {
    likes: 478,
    comments: [
      { author: 'Kevin Zhao', date: '2026-03-24', text: 'The restaurant/delivery app analogy is perfect. Apple literally banned the competition\'s delivery service while launching their own. The "different rules for different roles" argument falls apart when you realize the end result is identical — AI-generated Swift code running on someone\'s iPhone.' },
      { author: 'Samira Hassan', date: '2026-03-24', text: 'I\'m one of the 63% non-developers who uses vibe coding. Built my first app with Replit last month. It\'s a budgeting tracker for my freelance business. Nothing fancy. It works. Now I can\'t update it? Because Apple decided the tool I used to build it is a "trojan horse"? Cool. Cool cool cool.' },
      { author: 'Marcus Webb', date: '2026-03-24', text: 'The bouncer wearing Jordans line made me ugly-laugh in a meeting. But seriously — the Xcode AI agents are doing THE SAME THING. The only difference is Apple can see the code before it compiles. That\'s a legitimate security argument but it\'s not the argument Apple made. They cited 2.5.2 which is about post-review code execution, not code quality.' },
      { author: 'Dylan Park', date: '2026-03-24', text: 'The junior developer stats are terrifying and not talked about enough. 67% drop in entry-level roles. Where do the next seniors come from? You can\'t skip junior. That\'s not how expertise works. AI can generate code but it can\'t generate 5 years of debugging experience at 2 AM.' },
      { author: 'Mario', date: '2026-03-24', text: 'Dylan — that\'s the part that keeps me up. Everyone\'s arguing about App Store rules while the talent pipeline quietly breaks. In 2031 when companies desperately need senior engineers who understand systems deeply, they\'ll realize those people were never created because nobody hired them in 2026. The math is simple and the math is scary.' },
      { author: 'Rachel Kim', date: '2026-03-24', text: 'The non-coder mom who built Crash Out Diary is such a perfect example. She had a real problem, used a real tool, built a real app that real people use. Now Apple says the tool she used isn\'t welcome. She\'s not going to learn Xcode. She\'s going to go back to not building. That\'s not protecting quality — it\'s protecting incumbents.' },
      { author: 'Tomás Herrera', date: '2026-03-24', text: 'Addy Osmani\'s distinction between vibe coding and AI-assisted engineering is the most important thing in this whole debate. The problem was never AI writing code. The problem is code shipping without anyone understanding it. Xcode forces you to look at the code. Replit... doesn\'t. That\'s a real difference even if Apple\'s enforcement is hypocritical.' },
      { author: 'Chris Müller', date: '2026-03-24', text: 'The SaaS guy on Reddit who got hacked — "zero hand-written code also meant zero hand-written security" — deserves to be framed. That\'s the entire vibe coding debate in one sentence. Not every app needs military-grade security. But if you\'re handling user data and you can\'t explain your own auth flow? That\'s malpractice.' },
      { author: 'Priya Sharma', date: '2026-03-24', text: 'Your prediction section is probably right. Apple will add an "AI-generated" disclosure flag within 6 months. It\'s the path of least resistance — tracks the trend without blocking it, lets them collect data, and gives reviewers a heads-up. Plus it shifts liability: "we told you it was AI-generated, you chose to download it."' },
      { author: 'Ben Okafor', date: '2026-03-24', text: '"The answer isn\'t blocking tools. The answer is raising the floor." This should be Apple\'s actual policy. Mandatory security scanning. Required test coverage before submission. Automated vulnerability detection. These are boring solutions that actually work. But boring doesn\'t make headlines and banning Replit does.' },
      { author: 'Elise Johansson', date: '2026-03-24', text: 'Karpathy declaring his own term passé less than a year after coining it is the most tech thing that has ever happened. "Agentic engineering" will last about 4 months before someone coins something newer. The nomenclature treadmill is exhausting. Can we just call it "using AI to code" and move on?' },
      { author: 'Jake Morrison', date: '2026-03-24', text: 'The Lovable security stats are damning. 10.3% critical flaws. One in ten apps. These aren\'t edge cases, they\'re systemic. I understand why Apple panicked. I just wish the panic had produced a better solution than "block the platforms we don\'t own."' },
    ],
  },
