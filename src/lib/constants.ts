...
export const APPS = {
  ...
  thinkbud: {
    ...
    description: 'Import any link, PDF, image, or audio — ThinkBud instantly transforms it into brain maps, summaries, flash cards, quizzes, and memory games. Then export stunning PNG mind maps, interactive HTML presentations, or PowerPoint decks.',
    ...
    features: [
      ...
      { title: 'Smart Flash Cards', description: 'AI-generated flash cards with spaced repetition. Swipe through and master any subject at your own pace.', icon: 'layers' },
