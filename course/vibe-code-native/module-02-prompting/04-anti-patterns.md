# Lesson 2.4 — Anti-Patterns: The Top 10 Mistakes
...
| **Resources needed** | Slide deck with code examples |
| **Prerequisite** | Lessons 2.1-2.3 |

---

## Outline

- 10 anti-patterns that waste time and produce bad code
- Each with: the mistake, why it fails, and the fix
- Real examples from actual prompts and outputs
- Quick reference card for avoiding common pitfalls
...
[SCREEN: Title slide — "10 Anti-Patterns That Will Ruin Your Vibe"]
...
[SCREEN: Slide showing a wall of text]
...
[SCREEN: Slide with warning icon]
...
[SCREEN: Slide — sunk cost diagram]
...
[SCREEN: Terminal showing a git diff]
