# Lesson 2.2 — CLAUDE.md: Your AI Playbook
...
|-----|-------|
| **Duration** | ~15 minutes |
| **Format** | Screen recording (terminal + code editor) |
| **Resources needed** | Claude Code + Xcode project, example CLAUDE.md files |
...
- What is CLAUDE.md and why it changes everything
- How Claude Code reads and applies your rules
- Building a CLAUDE.md from scratch — section by section
- Real-world example: the rules we use for Invoize
- Common mistakes and how to avoid them
- Template: a production-ready CLAUDE.md for any iOS project
...
[SCREEN: Terminal showing a CLAUDE.md file]
...
[SCREEN: Slide — diagram showing CLAUDE.md flow]
...
[SCREEN: Code editor showing CLAUDE.md being built section by section]
...
[SCREEN: Show a sanitized version of the Invoize CLAUDE.md]
...
[SCREEN: Highlight key differences from the generic template]
...
[SCREEN: Slide — "CLAUDE.md Mistakes"]
